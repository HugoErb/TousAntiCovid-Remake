...
public class LieuxController {
	...
	private void changeScreenButton (ActionEvent event) throws IOException {
		...
		else{ if(event.getSource() == pageAccueil){
	...
	/**
	 * M�thode appel�e quand l'user clique sur le bouton "se d�clarer pr�sent".
	 */
	@FXML
	private void boutonPresence() {
